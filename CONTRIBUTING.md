...
The following is a set of guidelines for contributing to collections. 
...
The collections team strives to create a
...
Please use our [Issue Tracker](https://github.com/lmodel/collections/issues/) for reporting problems with the ontology. 
